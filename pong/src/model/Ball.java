...
public class Ball extends Observable implements MovingObject, RectangularShaped {
	...
	public Ball() {
		this(DEFAULT_RADIUS, DEFAULT_START_X, DEFAULT_START_Y, DEFAULT_H_SPEED,
				DEFAULT_V_SPEED);
	}
	 ...
	 */
	public void update(PongModel model) {
		x += horizontalSpeed;
		y += verticalSpeed;
	...
	private void handleBump(PongModel model) {
		Map<RectangularShaped, MyDoubleRectangle2D> map = model.getAssosBoundingBoxes();
		MyDoubleRectangle2D rectBall = map.get(this);
